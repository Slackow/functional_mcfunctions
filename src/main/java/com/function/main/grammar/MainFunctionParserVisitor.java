...
public interface MainFunctionParserVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by the {@code RangeExpressionNoInc}
     * labeled alternative in {@link MainFunctionParser#range_expr}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitRangeExpressionNoInc(MainFunctionParser.RangeExpressionNoIncContext ctx);

    /**
     * Visit a parse tree produced by the {@code RangeExpressionInc}
     * labeled alternative in {@link MainFunctionParser#range_expr}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitRangeExpressionInc(MainFunctionParser.RangeExpressionIncContext ctx);
}